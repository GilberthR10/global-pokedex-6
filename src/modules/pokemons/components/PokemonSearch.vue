...
<template>
  <div class="relative bg-white rounded-md w-full px-4 py-2.5 flex items-center shadow-md">
    <!-- Icono de búsqueda -->
    <IconSearch class="mr-2" />

    <!-- Input -->
    <input v-model="searchInput" type="text" placeholder="Search" @input="debouncedSearch(searchInput)"
